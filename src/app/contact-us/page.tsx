                ...
                <div className="w-full h-full flex flex-col items-center bg-background rounded-b-md overflow-hidden shadow-md">
                    <div className="h-full w-full text-textColor flex flex-col px-6 py-4 md:px-12 md:py-10 lg:px-32 lg:py-20 max-w-[1200px]">
                        ...
                        <p className="text-base/5 font-light text-textColor text-gray-800 lg:text-base">
                            For admissions, course details, or any other
                            queries, feel free to reach out to us. We would love
                            to hear from you! If you have any questions,
                            comments, or suggestions, please feel free to
                            contact us. You can reach us by phone, WhatsApp, or
                            by following us on social platform. We will get back
