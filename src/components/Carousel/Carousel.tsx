...
const carouselImages = [
    ...
    {
        image: caroselImg2,
        displayText: "A Complete Computer Learning Solution",
    },
];
...
export default function Carousel() {
    return (
        <Swiper
            className={clsx([
                "w-full sm:aspect-[21/8] bg-sky-200",
                "aspect-[4/5]",
            ])}
                ...
                <SwiperSlide key={imageData.image.src}>
                    ...
                    >
                        ...
                        >
                            <h1
                                className={clsx([
                                    "text-textSecondaryColor text-5xl font-bold",
                                    "text-center",
                                ])}
                            >
                                {imageData.displayText}
                            </h1>
                            <ButtonLink
                                buttonType="square"
                                href={"/contact-us"}
                                className={clsx([
                                    "px-3 py-1 shadow-sm rounded-sm",
                                ])}
                            >
                                Contact us
                            </ButtonLink>
                    ...
                    >
                        ...
                        >
                            <h1
                                className={clsx([
                                    "text-textSecondaryColor text-7xl font-bold",
                                    "text-center",
                                ])}
                            >
                                {imageData.displayText}
                            ...
                            <ButtonLink
                                ...
                                href={"/contact-us"}
                                className={clsx([
                                    "absolute px-5 py-2 shadow-sm rounded-sm bottom-[10%] lg:text-2xl",
                                ])}
                            >
                                Contact us
                            </ButtonLink>
